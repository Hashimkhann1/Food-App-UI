...
class ResturentViewWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return InkWell(
      onTap: () {
        Navigator.push(context, MaterialPageRoute(builder: (context) => ResturantDetailView(restImage: restImage,)));
      },
      child: Container(
        width: width * 0.68,
              ...
              children: [
                ClipRRect(
                  borderRadius: BorderRadius.only(topRight: Radius.circular(16),topLeft: Radius.circular(16)),
                    child: Image.asset(restImage,height: height * 0.20,fit: BoxFit.cover,)),
                Positioned(
                  top: 10,
                  right: 10,
                  child: Container(
